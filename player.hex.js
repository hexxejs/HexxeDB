...
<button id="albumbtnplay" style="position: absolute; width: 50px; height: 50px; right: 0;" class="trackplay" onclick="setPause(); document.getElementById('hex-player').style.visibility='visible'; document.getElementById('track0').style.display = 'block'; togTrackRep(); hexPlayer('0');">
...
function setPause(){
let elem = document.getElementById('albumbtnplay'); 
elem.setAttribute('onclick', `hexPlayer('none');`); 
}
