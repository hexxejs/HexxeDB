...
let url = xqlurl+'/adddb.php';
let params = "sess=880&key="+key+"&name="+tname;
...
nameh.innerHTML = "<th>Database</th>";
...
sno.innerHTML = "<td>"+base+"</td> <i class='fa fa-arrow-right' margin='10px left' size='20px' link='tab.html?tab="+base+"'></i>"; 
...
let path = xqlurl+"/editdb.php?key="+passkey+"&tab="+old+"&sess="+makeid(5); 
